...
exports.DEFAULT_IMAGE_URL = exports.ensureProductImage = exports.ensureProductImages = exports.getImagePath = void 0;
 ...
 */
const ensureProductImages = (products) => {
    if (!products)
        return [];
    return products.map((product) => ({
        ...product,
        imagePath: (0, exports.getImagePath)(product.imagePath),
    }));
};
exports.ensureProductImages = ensureProductImages;
/**
...
exports.ensureProductImage = ensureProductImage;
exports.DEFAULT_IMAGE_URL = `${BASE_URL}${DEFAULT_FILENAME}`;
// /**
//  * Utility functions for handling product images
//  */
